...
function exec(message) {
	...
	.setTimestamp()
	.setFooter('Dont break the rule or be BANNED', 'https://cdn.discordapp.com/avatars/447916021198749696/e50d862fc11eb14337d95f8529e4aa21.png?size=2048');

message.channel.send(exampleEmbed);

}

module.exports = new Command('Rules', exec, {
    aliases: ['rules', 'rule']
});